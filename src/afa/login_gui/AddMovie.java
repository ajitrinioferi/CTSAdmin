...
public class AddMovie extends javax.swing.JFrame {
    ...
    public AddMovie() {
        initComponents();
        PromptSupport.setPrompt("Movie Title", TextField_MovieName);
        PromptSupport.setPrompt("genre | genre | genre", TextField_MovieGenre);
        PromptSupport.setPrompt("yyyy-mm-dd", TextField_MovieReleaseDate);
        PromptSupport.setPrompt("yyyy-mm-dd", TextField_MovieStartRelease);
        PromptSupport.setPrompt("yyyy-mm-dd", TextField_MovieEndRelease);
        PromptSupport.setPrompt("Production House", TextField_MovieProduction);
        PromptSupport.setPrompt("Director Name", TextField_MovieDirector);
        PromptSupport.setPrompt("In Minutes", TextField_MovieDuration);
        PromptSupport.setPrompt("00", TextField_AgeRestriction);
    }
        /**
    ...
    private void initComponents() {
        ...
        setLocation(new java.awt.Point(353, 244));
        setName("AddMovie"); // NOI18N
        setUndecorated(true);

        bg.setBackground(new java.awt.Color(0, 0, 0));
        bg.setMaximumSize(new java.awt.Dimension(660, 410));
        ...
        AddpanelLayout.setHorizontalGroup(
            ...
            .addGroup(AddpanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(btn_add, javax.swing.GroupLayout.PREFERRED_SIZE, 52, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        bg.add(Addpanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(576, 11, -1, 250));
        ...
        bg.add(TextField_MovieName, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 10, 240, 30));
        ...
        bg.add(Label_MovieName, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, -1, -1));
        ...
        TextField_MovieGenre.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        bg.add(TextField_MovieGenre, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 50, 240, 30));
        ...
        bg.add(Label_MovieGenre, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, -1, -1));
        ...
        TextField_MovieReleaseDate.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        bg.add(TextField_MovieReleaseDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 90, 240, 30));
        ...
        bg.add(Label_MovieReleaseDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, -1, -1));
        ...
        TextField_MovieProduction.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        bg.add(TextField_MovieProduction, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 130, 240, 30));
        ...
        bg.add(Label_MovieProduction, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, -1, -1));
        ...
        TextField_MovieDirector.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        bg.add(TextField_MovieDirector, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 170, 240, 30));
        ...
        bg.add(Label_MovieDirector, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, -1, -1));
        ...
        bg.add(Label_MovieStartRelease, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 20, 140, -1));
        ...
        bg.add(TextField_MovieStartRelease, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 30, 140, 30));
        ...
        bg.add(Label_MovieEndRelease, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 70, 140, -1));
        ...
        bg.add(TextField_MovieEndRelease, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 80, 140, 30));
        ...
        bg.add(Label_MovieDuration, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 119, 140, 20));
        ...
        bg.add(TextField_MovieDuration, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 130, 140, 30));
        ...
        bg.add(Label_MovieAgeRestriction, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 180, -1, -1));
        ...
        bg.add(TextField_AgeRestriction, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 170, 30, 30));
        ...
        bg.add(ico_Back, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, -1, -1));
        ...
        bg.add(ico_Exit, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 230, -1, -1));
        ...
        bg.add(Label_AddMovie, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 230, 120, 30));
        ...
        bg.add(Label_Copyright, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 230, 126, 30));
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(bg, javax.swing.GroupLayout.PREFERRED_SIZE, 280, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void AddpanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AddpanelMouseClicked
        ...
        try {
            ...
            if (releaseDate.compareTo(startDate) <= 0 && startDate.compareTo(endDate) <= 0
                ...
                try {
                    // TODO add your handling code here:
                    Movie movie_data = new Movie(); // namanya inisialisasi kelas enkapsulasi movie.java
                    movie_data.setTitle(TextField_MovieName.getText()); // setter
                    movie_data.setGenre(TextField_MovieGenre.getText());
                    movie_data.setReleaseDate(TextField_MovieReleaseDate.getText());
                    movie_data.setProductionBy(TextField_MovieProduction.getText());
                    movie_data.setFilmDirector(TextField_MovieDirector.getText());
                    movie_data.setDuration(TextField_MovieDuration.getText());
                    movie_data.setAgeRestriction(TextField_AgeRestriction.getText());
                    movie_data.setStartDate(TextField_MovieStartRelease.getText());
                    movie_data.setEndDate(TextField_MovieEndRelease.getText());
                    String query = " insert into movies (Title, Genre, ReleaseDate, ProductionBy, FilmDirector, Duration, AgeRestriction, StartDate, EndDate)"
                            + " values (?, ?, ?, ?, ?, ?, ?, ?, ?)";
                    PreparedStatement preparedStmt = AFAUtils.conn.prepareStatement(query);
                    preparedStmt.setString(1, movie_data.getTitle()); //getter
                    preparedStmt.setString(2, movie_data.getGenre());
                    preparedStmt.setString(3, movie_data.getReleaseDate());
                    preparedStmt.setString(4, movie_data.getProductionBy());
                    preparedStmt.setString(5, movie_data.getFilmDirector());
                    preparedStmt.setInt(6, Integer.parseInt(movie_data.getDuration()));
                    preparedStmt.setInt(7, Integer.parseInt(movie_data.getAgeRestriction()));
                    preparedStmt.setString(8, movie_data.getStartDate());
                    preparedStmt.setString(9, movie_data.getEndDate());
